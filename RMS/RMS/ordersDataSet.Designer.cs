...
namespace WindowsFormsApplication1 {
    ...
    public partial class ordersDataSet : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataTable1Row AddDataTable1Row(int order_id, System.DateTime dop, string category, int payment, string Source, string Destination, string Expr2) {
        ...
        public partial class DataTable1Row : global::System.Data.DataRow {
            ...
            public System.DateTime dop {
                get {
                    return ((global::System.DateTime)(this[this.tableDataTable1.dopColumn]));
                }
                set {
                    this[this.tableDataTable1.dopColumn] = value;
                }
            }
            ...
            public int payment {
                get {
                    try {
                        return ((int)(this[this.tableDataTable1.paymentColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace WindowsFormsApplication1.ordersDataSetTableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        orderTable.order_id, orderTable.dop, orderTable.category, orderTable.payment, stationTable.name AS Source, stationTable_1.name AS Destination, companyTable.name AS Expr2
FROM            orderTable INNER JOIN
                         placeOrder ON orderTable.order_id = placeOrder.order_id INNER JOIN
                         companyTable ON placeOrder.company_id = companyTable.company_id INNER JOIN
                         stationTable ON orderTable.source = stationTable.station_id INNER JOIN
                         stationTable AS stationTable_1 ON orderTable.destination = stationTable_1.station_id
WHERE        (companyTable.name = @name)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@name", global::System.Data.SqlDbType.VarChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "Expr2", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(ordersDataSet.DataTable1DataTable dataTable, string name) {
        ...
        public virtual ordersDataSet.DataTable1DataTable GetData(string name) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((name == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            ordersDataSet.DataTable1DataTable dataTable = new ordersDataSet.DataTable1DataTable();
